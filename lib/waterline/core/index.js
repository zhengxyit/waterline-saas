...
var Core = module.exports = function (options) {
    ...
    if (this.multitenant) {
        this.attributes.tenantId = {type: 'text'};
    }
    ...
    if(!Object.getPrototypeOf(this).hasOwnProperty('migrate')){
        console.error("migrate not found")
    }
...
Core._initialize = function (options) {
    ...
    if (this.multitenant) delete _validations.tenantId;
